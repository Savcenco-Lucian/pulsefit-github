    ...
    <div className='mt-24'>
      <div className='flex items-center justify-between px-7'>
        <div className='flex'>
          ...
          <p className='text-xs font-oswald text-[#D7FB00] opacity-60 md:text-base'>Testimonials</p>
        </div>

        <div className='border border-[#D7FB00] opacity-60 px-2 py-1 rounded-full'>
          <p className='text-xs text-center font-oswald text-[#D7FB00] opacity-60 md:text-base'>06</p>
        </div>
      </div>

      <SmoothReveal><h1 className='text-white font-oswald font-semibold text-4xl text-center md:text-6xl'>CLIENT <span className='text-[#D7FB00]'>REVIEWS</span></h1></SmoothReveal>
      <section>
        <div className=" px-7 py-7 sm:px-6 lg:px-8">
          <div className="mt-8 [column-fill:_balance] sm:columns-2 sm:gap-6 lg:columns-3 lg:gap-8">
            <div className="mb-8 sm:break-inside-avoid">
              <blockquote className="rounded-lg border border-[#D7FB00] p-6 shadow-sm sm:p-8">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="flex justify-center gap-0.5 text-[#D7FB00]">
                      <svg
                    ...
                    <p className="mt-0.5 text-lg font-medium text-white">Paul Starr</p>
                  </div>
                </div>
